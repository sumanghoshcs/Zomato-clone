...
function FoodCard(props) {
  ...
  return (
    <div className="max-w-sm overflow-hidden p-3 rounded-2xl hover:shadow-2xl hover:border" onClick={handleClick}>
      <img className="w-full h-56 rounded-2xl" src={props.src} alt={props.name} />
      <div className="flex flex-row justify-between">
        ...
        <div className="py-4 text-right gap-10">
          <div className="flex items-center ml-9 rounded-lg p-1 bg-green-800">
            <p className="text-white font-semibold text-center text-sm">{props.rating}</p>
